...
class dc_jqsocialstream {
	...
	function add_dcwss_scripts() {
		...
		wp_enqueue_script( 'dcwss-wall', dc_jqsocialstream::get_plugin_directory() . '/js/jquery.social.stream.wall.1.3.js' );
		wp_enqueue_script( 'dcwss', dc_jqsocialstream::get_plugin_directory() . '/js/jquery.social.stream.1.5.4.min.js' );
