...
if(!class_exists('dcwp_plugin_admin_dcwss')) {
	...
	class dcwp_plugin_admin_dcwss {
		...
		function dcwp_advert() {
			...
			$content .= '<li><a href="http://www.designchemical.com/blog/index.php/premium-wordpress-plugins/premium-wordpress-plugin-top-social-share-posts/" class="dc-external"><img src="'.dc_jqsocialstream::get_plugin_directory().'/images/dctsp_125.jpg" alt="Top Social Share Posts" /></a></li>';
			$content .= '</ul>';
