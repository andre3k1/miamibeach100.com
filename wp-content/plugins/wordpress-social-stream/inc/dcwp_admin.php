...
if(!class_exists('dc_jqsocialstream_admin')) {
	...
	<?php
		...
		function add_dcwss_option_styles() {
			...
			wp_enqueue_style("dcwss_option_css", dc_jqsocialstream::get_plugin_directory(). "/css/colorpicker.css");
		}

		function add_dcwss_option_scripts() {
			wp_enqueue_script('jquery-ui-core');
			wp_enqueue_script('dcwss_option_eye', dc_jqsocialstream::get_plugin_directory(). '/inc/js/eye.js');
			wp_enqueue_script('dcwss_option_colorpicker', dc_jqsocialstream::get_plugin_directory(). '/inc/js/colorpicker.js');
		}
	}
}